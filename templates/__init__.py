...
def index():
    ...
    def __template__():
        ...
        yield '', join_('                //initialize calendar\n')
        ...
        yield '', join_('                                };\n')
        yield '', join_('                                \n')
        yield '', join_("                                if(timeString.indexOf('TBA') != -1) {\n")
        yield '', join_('                                        broadcastMessage("Course had an invalid time!");\n')
        yield '', join_('                                        return false;\n')
        yield '', join_('                                }\n')
...
def schedule():
    ...
    def __template__ (schedule):
        ...
        yield '', join_('<html>\n')
        yield '', join_('<head>\n')
        yield '', join_('        <title>Schedule</title>\n')
        yield '', join_("        <link rel='stylesheet' type='text/css' href='/static/css/main.css' />\n")
        yield '', join_('</head>\n')
        yield '', join_('<body>\n')
...
def search():
    ...
    def __template__ (search_form):
        ...
        yield '', join_('<html>\n')
        yield '', join_('<head>\n')
        yield '', join_('        <title>Search</title>\n')
        yield '', join_("        <link rel='stylesheet' type='text/css' href='/static/css/main.css' />\n")
        yield '', join_('</head>\n')
        yield '', join_('<body>\n')
