...
def index():
    ...
    extend_([u'        \n'])
    extend_([u'        var YEAR = 2010; //static calendar year\n'])
    extend_([u'        var MONTH = 4; //static calendar month (May)\n'])
    extend_([u'        var DAY = 3; //Monday the 3rd \n'])
    extend_([u'        \n'])
    ...
    extend_([u'                return Math.floor(Math.random() * 101);\n'])
    extend_([u'        }\n'])
    extend_([u'        \n'])
    extend_([u'        //parses course string into readable format ie. INF 41 Software Reqs\n'])
    extend_([u'        function parseCourseString(courseString) {\n'])
    ...
    extend_([u'                \n'])
    extend_([u'                return (courseNumber + courseName);\n'])
    extend_([u'        }\n'])
    extend_([u'        \n'])
    ...
    extend_([u'                \n'])
    extend_([u"                if(timeString.indexOf('M') != -1) {\n"])
    extend_([u"                        courseDates.push(days['M']);\n"])
    extend_([u'                } \n'])
    extend_([u'                \n'])
    extend_([u"                if(timeString.indexOf('Tu') != -1) {\n"])
    extend_([u"                        courseDates.push(days['Tu']);\n"])
    extend_([u'                } \n'])
    extend_([u'                \n'])
    extend_([u"                if(timeString.indexOf('W') != -1) {\n"])
    extend_([u"                        courseDates.push(days['W']);\n"])
    extend_([u'                }\n'])
    extend_([u'                \n'])
    extend_([u"                if(timeString.indexOf('Th') != -1) {\n"])
    extend_([u"                        courseDates.push(days['Th']);\n"])
    extend_([u'                }\n'])
    extend_([u'                \n'])
    extend_([u"                if(timeString.indexOf('F') != -1) {\n"])
    extend_([u"                        courseDates.push(days['F']);\n"])
    extend_([u'                }\n'])
    extend_([u'                \n'])
    ...
    extend_([u'                        var e = {       \n'])
    extend_([u'                                "id": genID(),\n'])
    extend_([u'                                "start": new Date(YEAR, MONTH, courseDates[i], courseTime.startHour, courseTime.startMin),\n'])
    extend_([u'                                "end": new Date(YEAR, MONTH, courseDates[i], courseTime.endHour, courseTime.endMin),\n'])
    ...
    extend_([u'                        timeslotsPerHour: 2,\n'])
    extend_([u'                        useShortDayNames: true,\n'])
    extend_([u'                        firstDayOfWeek: 1,\n'])
    extend_([u'                        daysToShow:5,\n'])
    extend_([u'                        businessHours: {start: 8, end: 21, limitDisplay: true},\n'])
    ...
    extend_([u'                                return jQuery(window).height() - jQuery("h1").outerHeight();\n'])
    extend_([u'                        }\n'])
    extend_([u'                });\n'])
    extend_([u'                \n'])
    extend_([u"                jQuery('#calendar').weekCalendar('gotoWeek',  new Date(YEAR, MONTH, DAY));\n"])
    extend_([u'                \n'])
    extend_([u'                //\n'])
    extend_([u"                jQuery('#school').load(function() {\n"])
    extend_([u"                        var list = jQuery('.course-list', frames['school'].document);\n"])
    extend_([u'                        \n'])
    extend_([u'                        //add courses to calendar on click\n'])
    ...
    extend_([u'                                        parseCourseString(courseString),\n'])
