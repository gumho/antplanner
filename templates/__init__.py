...
def index():
    ...
    extend_([u'        function constructCourseName(courseString, courseType) {\n'])
    ...
    extend_([u'                \n'])
    extend_([u'                return (courseNumber + courseType);\n'])
    extend_([u'        }\n'])
    extend_([u'        \n'])
    ...
    extend_([u'                                }\n'])
    extend_([u'                                \n'])
    extend_([u'                                //remove courses from the course bag \n'])
    extend_([u'                                for(i in eventsToDelete) {\n'])
    extend_([u'                                        COURSE_BAG.splice(i, 1);\n'])
    extend_([u'                                }\n'])
    extend_([u'                                \n'])
    extend_([u'                                alert(COURSE_BAG.length);\n'])
    extend_([u'                        }\n'])
    extend_([u'                });\n'])
    extend_([u'                \n'])
    ...
    extend_([u'                                        constructCourseName(courseString, courseType),\n'])
